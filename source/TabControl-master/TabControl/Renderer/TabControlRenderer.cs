...
namespace Manina.Windows.Forms
{
    public partial class TabControl
    {
        ...
        public class TabControlRenderer
        {
            ...
            /// </summary>
            public virtual Color BorderColor { get; set; } = Color.Black;//Color.FromArgb(135, 135, 135);

            /// <summary>
            /// Gets or sets the background color of inactive tabs.
            /// </summary>
            public virtual Color InactiveTabBackColor { get; set; } = Color.FromArgb(233, 233, 233);
            /// <summary>
            ...
            /// </summary>
            public virtual Color PressedTabBackColor { get; set; } = Color.FromArgb(44, 50, 56);
            /// <summary>
            ...
            /// </summary>
            public virtual Color SeparatorColor { get; set; } = Color.Black;
            ...
            //                    g.DrawLine(pen, param.Bounds.Left, param.Bounds.Top + 1, param.Bounds.Left, param.Bounds.Bottom - 1);
            //                if (param.Index == Parent.Tabs.Count - 1 && Parent.ScrollButtons)
            //                    g.DrawLine(pen, param.Bounds.Right - 1, param.Bounds.Top + 1, param.Bounds.Right - 1, param.Bounds.Bottom - 1);
            //            }
            //            else
            //            {
            //                if (param.Index != Parent.SelectedIndex + 1 && (param.Index != 0 || (param.Index == 0 && Parent.ScrollButtons)))
            //                    g.DrawLine(pen, param.Bounds.Left + 1, param.Bounds.Top, param.Bounds.Right - 1, param.Bounds.Top);
            //                if (param.Index == Parent.Tabs.Count - 1 && Parent.ScrollButtons)
            //                    g.DrawLine(pen, param.Bounds.Left + 1, param.Bounds.Bottom - 1, param.Bounds.Right - 1, param.Bounds.Bottom - 1);
            //            }
            //        }
            //    }
            //}
            ...
            public virtual void DrawBorder(Graphics g, Rectangle borderBounds)
            {
                ...
                //if ((Parent.TabLocation & TabLocation.Top) != TabLocation.None)
                //{
                //    pt[0] = borderBounds.GetBottomLeft().GetOffset(-1, 0);
                //    pt[1] = borderBounds.GetBottomRight();
                //    pt[2] = borderBounds.GetTopRight();
                //    pt[3] = tabBounds.GetBottomRight().GetOffset(-1, -1);
                //    pt[4] = tabBounds.GetTopRight().GetOffset(-1, 0);
                //    pt[5] = tabBounds.GetTopLeft();
                //    pt[6] = tabBounds.GetBottomLeft().GetOffset(0, -1);
                //    pt[7] = borderBounds.GetTopLeft().GetOffset(-1, 0);
                //}
                //else if ((Parent.TabLocation & TabLocation.Bottom) != TabLocation.None)
                //{
                //    pt[0] = borderBounds.GetBottomLeft().GetOffset(-1,-1);
                //    pt[1] = tabBounds.GetTopLeft();
                //    pt[2] = tabBounds.GetBottomLeft().GetOffset(0, -1);
                //    pt[3] = tabBounds.GetBottomRight().GetOffset(-1, -1);
                //    pt[4] = tabBounds.GetTopRight().GetOffset(-1, 1);
                //    pt[5] = borderBounds.GetBottomRight();
                //    pt[6] = borderBounds.GetTopRight().GetOffset(0, -1);
                //    pt[7] = borderBounds.GetTopLeft().GetOffset(-1, -1);
                //}
            ...
            protected Color GetTabBackColor(DrawTabParams param)
            {
                ...
                //    return UseTabColors ? param.Tab.BackColor.Darken(0.05f) : HotAndActiveTabBackColor;
                    ...
                    return Color.FromArgb(47, 54, 61);
                else if (param.IsSelected)
                    return UseTabColors ? param.Tab.BackColor : Color.FromArgb(246, 248, 250);
                else
                    return Color.FromArgb(36, 41, 46);
            }
            ...
            //    else
            //        return UseTabColors ? Color.FromArgb(36, 41, 46) : InactiveTabBackColor;
            //}
